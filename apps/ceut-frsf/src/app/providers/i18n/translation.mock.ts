...
export const MOCK_TRANSLATIONS: Record<string, string> = {
	...
	'LANDING.HERO_HEADING': 'Your faculty, all in one place',
	...
	'LANDING.PORTAL.FOOTER.TAGLINE': 'Student Center · UTN Facultad Regional Santa Fe',
	'LANDING.PORTAL.FOOTER.INSTAGRAM_TITLE': 'Follow us on Instagram',
	'LANDING.PORTAL.FOOTER.DISCORD_TITLE': 'Join our Discord',
	'LANDING.PORTAL.CARDS.BIBLIOTECA.TITLE': 'CEUT Library',
	'LANDING.PORTAL.CARDS.BIBLIOTECA.TEXT': 'Search and reserve books from the faculty catalog.',
	'LANDING.PORTAL.CARDS.BIBLIOTECA.FOOTER': 'Catalog · loans',
	'LANDING.PORTAL.CARDS.DONDE_CURSO.TITLE': 'Where do I have class?',
	'LANDING.PORTAL.CARDS.DONDE_CURSO.TEXT': 'Find the classroom for each subject and section.',
	'LANDING.PORTAL.CARDS.HORARIOS.TITLE': 'Schedules',
	'LANDING.PORTAL.CARDS.HORARIOS.TEXT': 'Build your class schedule for the semester.',
	'LANDING.PORTAL.CARDS.CALCULADORA.TITLE': 'Grade calculator',
	'LANDING.PORTAL.CARDS.CALCULADORA.TEXT': 'Estimate your average with and without failed exams.',
	'LANDING.PORTAL.CARDS.CALCULADORA.FOOTER': 'Tool',
	'LANDING.PORTAL.CARDS.BECAS.TITLE': 'CEUT Scholarships',
	'LANDING.PORTAL.CARDS.BECAS.TEXT': 'Financial and study-material aid for your studies.',
	'LANDING.PORTAL.CARDS.CAFE.TITLE': 'Café Tecnológico',
	'LANDING.PORTAL.CARDS.CAFE.TEXT': 'Talks and gatherings among students.',
	'LANDING.PORTAL.CARDS.CORO.TITLE': 'Faculty Choir',
	'LANDING.PORTAL.CARDS.CORO.TEXT': 'Join us to sing every Wednesday.',
	'LANDING.PORTAL.CARDS.CORO.FOOTER': 'Extracurricular',
	'LANDING.PORTAL.CARDS.CALENDARIO.TITLE': 'Academic Calendar',
	'LANDING.PORTAL.CARDS.CALENDARIO.TEXT': 'Dates for finals, enrollment and holidays.',
	'LANDING.PORTAL.CARDS.CAMPUS_VIRTUAL.TITLE': 'Virtual Campus',
	'LANDING.PORTAL.CARDS.CAMPUS_VIRTUAL.TEXT': 'Access the campus and your online courses.',
	'LANDING.PORTAL.CARDS.LIBROS_APUNTES.TITLE': 'Books & notes',
	'LANDING.PORTAL.CARDS.LIBROS_APUNTES.TEXT': 'Study material shared by the community.',
	'LANDING.PORTAL.CARDS.LIBROS_APUNTES.FOOTER': 'Community',
